...
export function FaqSection({ data }: { data?: any }) {
  const title = data?.faqTitle || 'Preguntas Frecuentes';
  const description = data?.faqDescription || 'Resolvemos algunas de las dudas más comunes que tienen nuestros clientes.';
