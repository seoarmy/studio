...
export const home = defineType({
    ...
    fields: [
        ...
        // Actual services list is likely to be dynamic or its own document type, but we can add a simple list here if needed.
        // Given the complexity of the current app, services are their own entity.
        ...
        defineField({
            ...
            initialValue: [
                ...
                },
                {
                    ...
                    answer: '¡Sí! Creemos que toda empresa merece crecer. Diseñamos estrategias a medida que se adaptan a diferentes niveles de inversión, siempre buscando maximizar el retorno de cada peso invertido, sin importar el tamaño del presupuesto.',
                },
                {
